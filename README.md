...
sample
<img width="400" height="500" alt="Image" src="https://github.com/user-attachments/assets/52d11766-9900-440f-981d-898d85df3e59" />  <img width="500" height="700" alt="Image" src="https://github.com/user-attachments/assets/68fc6fd6-e958-4fb1-b6ef-5f62dd0b12e7" />
<img width="400" height="500" alt="Image" src="https://github.com/user-attachments/assets/e03b533c-ec1e-40f1-bc0a-b7d226e476dc" />   <img width="500" height="700" alt="Image" src="https://github.com/user-attachments/assets/2125961f-e4ee-4795-b767-2e0521852eff" />

---

## Conclusion
• This project demonstrates the potential of using content-based filtering to develop a 
destination and hotel recommendation system that caters to user preferences. By 
leveraging attributes such as rating , price range, and location and facilities. 

---
## Future Scope 
• Future enhancements could include the integration of user feedback and advanced 
filtering techniques, such as collaborative or hybrid models, to make the 
recommendations more personalized and accurate.
